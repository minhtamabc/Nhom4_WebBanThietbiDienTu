...
class CartController extends Controller
{
    ...
    public function index()
    {
        $idProducts = DB::table('donhang')
                        ...
                        ->select('chitietdonhang.id_chi_tiet_thiet_bi','chitietdonhang.so_luong','chitietdonhang.tong_tien','donhang.id_don_hang')
        ...
        foreach($idProducts as $id){
            $item = DB::table('chitietthietbi')
                            ->select('ten','gia_ban','id_chi_tiet_thiet_bi','so_luong_ton_kho')
    ...
    public function clear($idDonHang)
    {
        ...
        if($state)
            ...
            return redirect()->route('cart.index')->with('errpr', 'Có lỗi xảy ra, vui lòng thử lại sau !');
    }
